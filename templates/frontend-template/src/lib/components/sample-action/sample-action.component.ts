...
@Component({
    selector: 'sample-action',
    templateUrl: './sample-action.component.html',
    styleUrls: ['./sample-action.component.scss']
})

export class SampleActionComponent
    ...
    @Output() configuration: EventEmitter<SampleActionConfig> = new EventEmitter<SampleActionConfig>();
